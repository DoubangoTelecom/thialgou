...
public:
  ...
  UInt	  getMbType			()							  const { return m_uiMbType; }
  ...
  Void	  setMbType( UInt uiMbType )							{ m_uiMbType = uiMbType; }
  ...
  Void	setBitsCount(UInt n) { m_uiBitsCount = n; } // Thialgou
  UInt	getBitsCount() { return	m_uiBitsCount; } // Thialgou
