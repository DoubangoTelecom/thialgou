                             ...
                             AccessUnit&  rcAccessUnit )
{
  ...
  Bool          bBufferingPeriod  = false;
  {
	...
	pcCurrent->setNaluType((CommonEnumFake)m_pcNalUnitParser ->getNalUnitType());
    ...
    case NAL_UNIT_SUBSET_SPS:
      {
        ...
        RNOK( pcSPS->read( m_pcHeaderSymbolReadIf, m_pcNalUnitParser->getNalUnitType(), bCompletelyParsed, m_pIoEventHdr ) );
...
ErrVal
H264AVCDecoder::SetIoEventHdr( const h264HdrEventParsing* pIoEventHdr )
{
