...
NalUnitParser::initNalUnit( BinDataAccessor& rcBinDataAccessor, Int iDQId )
{
  ...
  const_cast<CommonMainH264*>(CommonMain::getMainH264())->setLayer(iDQId == MSYS_INT_MIN ? 0 : iDQId);
  ...
  const CommonMainH264* pcMainH264 = CommonMain::getMainH264();
   ...
   const CommonH264Nalu* pcCurrent = dynamic_cast<const CommonH264Nalu*>(pcMainH264->getEltCurrent());
   if(pcCurrent /*&& pcCurrent->isUndefined()*/) {
	pcCurrent->setNaluType((CommonEnumFake)eNalUnitType);
   }
  ...
  case NAL_UNIT_SPS:
	...
	((CommonMainH264*)CommonMain::getMainH264())->printHeading("SEQUENCE PARAMETER SET");
    break;
  case NAL_UNIT_SPS_EXTENSION:
    DTRACE_HEADER( "SEQUENCE PARAMETER SET EXTENSION" );
	((CommonMainH264*)CommonMain::getMainH264())->printHeading("SEQUENCE PARAMETER SET EXTENSION");
    break;
  case NAL_UNIT_SUBSET_SPS:
    DTRACE_HEADER( "SUBSET SEQUENCE PARAMETER SET" );
	((CommonMainH264*)CommonMain::getMainH264())->printHeading( "SUBSET SEQUENCE PARAMETER SET");
    break;
  case NAL_UNIT_PPS:
    DTRACE_HEADER( "PICTURE PARAMETER SET" );
	((CommonMainH264*)CommonMain::getMainH264())->printHeading("PICTURE PARAMETER SET");
    break;
  case NAL_UNIT_SEI:
    DTRACE_HEADER( "SEI NAL UNIT" );
	((CommonMainH264*)CommonMain::getMainH264())->printHeading("SEI NAL UNIT");
    break;
  case NAL_UNIT_FILLER_DATA:
    DTRACE_HEADER( "FILLER DATA" );
	((CommonMainH264*)CommonMain::getMainH264())->printHeading("FILLER DATA");
    break;
  case NAL_UNIT_ACCESS_UNIT_DELIMITER:
    DTRACE_HEADER( "ACCESS UNIT DELIMITER" );
	((CommonMainH264*)CommonMain::getMainH264())->printHeading("ACCESS UNIT DELIMITER");
    break;
  case NAL_UNIT_END_OF_SEQUENCE:
    DTRACE_HEADER( "END OF SEQUENCE" );
	((CommonMainH264*)CommonMain::getMainH264())->printHeading("END OF SEQUENCE");
    bTrailingBits = false;
    break;
  case NAL_UNIT_END_OF_STREAM:
    DTRACE_HEADER( "END OF STREAM" );
	((CommonMainH264*)CommonMain::getMainH264())->printHeading("END OF STREAM");
    bTrailingBits = false;
    break;
  case NAL_UNIT_PREFIX:
    DTRACE_HEADER( "PREFIX UNIT" );
	((CommonMainH264*)CommonMain::getMainH264())->printHeading("PREFIX UNIT" );
  ...
  case NAL_UNIT_CODED_SLICE_SCALABLE:
    DTRACE_NEWSLICE;
	((CommonMainH264*)CommonMain::getMainH264())->startSlice();
    break;
  ...
  case NAL_UNIT_RESERVED_23:
	...
	((CommonMainH264*)CommonMain::getMainH264())->printHeading("RESERVED" );
    bTrailingBits = false;
    break;
  default:
    DTRACE_HEADER( "UNSPECIFIED" );
	((CommonMainH264*)CommonMain::getMainH264())->printHeading("UNSPECIFIED");
    bTrailingBits = false;
    break;
  }
