...
ErrVal  
CreaterH264AVCDecoder::SetIoEventHdr( const h264HdrEventParsing* pIoEventHdr )
{
	m_pIoEventHdr = pIoEventHdr;
	if (m_pcH264AVCDecoder ){
		return m_pcH264AVCDecoder->SetIoEventHdr( m_pIoEventHdr );
	}
	return Err::m_nOK;
}

const h264HdrEventParsing*
CreaterH264AVCDecoder::GetIoEventHdr ()
{
